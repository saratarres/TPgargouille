...
//We've created a .h document with all the ppm.c functions and we've included it into the new document so when we call the functions they exist in the joined document.
